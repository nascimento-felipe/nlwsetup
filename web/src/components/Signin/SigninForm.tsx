...
interface SigInProps {
  shouldHideModal: (taskFinished: boolean) => void;
}

export function SigninForm({ shouldHideModal }: SigInProps) {
  ...
  return (
    <form onSubmit={handleSignin} className='w-full flex flex-col mt-6'>
